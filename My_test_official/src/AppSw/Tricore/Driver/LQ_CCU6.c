...
extern unsigned char res;     //倒车flag
extern int encValue5;
volatile int cnt = 0;
unsigned int cnt_return = 0;
unsigned char dao_flag = 0;
unsigned int hd_cnt = 0;
unsigned char hd_flag;
...
// 定时器中断标志位
char TIMER_CC60_CH0 = 0;
char TIMER_CC60_CH1 = 0;
char TIMER_CC61_CH0 = 0;
char TIMER_CC61_CH1 = 0;
...
void CCU60_CH0_IRQHandler (void)
{
    ...
    /* 用户代码 */
    encValue5 = -ENC_GetCounter(ENC6_InPut_P20_3);     //当前编码器的实际值
}
